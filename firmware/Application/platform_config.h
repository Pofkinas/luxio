#ifndef APPLICATION_PLATFORM_CONFIG_H_
#define APPLICATION_PLATFORM_CONFIG_H_

/***********************************************************************************************************************
 * @file 
 * @brief Platform configuration header file for the Pofkinas Development Framework (PDF).
 *
 * This file contains feature flags and configuration settings for various modules and peripherals used in the application.
 * This file should be included in your project to configure the framework according to your hardware and application needs.
 *
 * @note Place this file in the Application/ folder of your project and define it in your build settings.
 * 
 * @details
 * platform_config.h
 *
 ...
 * 3. In your build settings (e.g. CubeIDE), add:
 *      -DPROJECT_CONFIG_H="platform_config.h"
 *    to your compiler preprocessor defines.
 * 4. Ensure your Application/ folder is on the include path before the Framework include folder.
 * 5. Uncomment the feature flags below to enable support for specific modules.
 * 6. Change the module-specific constants in each section as needed.
 * 7. Building project will use only the enabled features.
 ***********************************************************************************************************************/
...
#define WS2812B_1_LED_COUNT 85
#endif

#ifdef USE_WS2812B_2
/// Number of LEDs on strip
#define WS2812B_2_LED_COUNT 85
#endif
